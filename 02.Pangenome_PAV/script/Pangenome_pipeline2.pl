...
foreach my $sam (sort keys %genomes) {
	...
	print $SH081 "perl $bincf{bindir}/script/step13.gene_p.pl $ntdepth_stat_ref $genedepth_stat_ref\n";
	close $SH081;
...
foreach my $sam (sort keys %genomes) {
	...
	print $SH17 "perl $bincf{bindir}/script/step22.filt3.pl $ref_fq $sort_refbam $sort_refmapbam $pav_dir2/$sam/$sam.refmap.reads.gz $pav_dir2/$sam/$sam.ref2unmap.reads\n";
	print $SH17 "perl $bincf{bindir}/script/step11.unmap_unmapread2.pl $pav_dir2/$sam/step08.$sam.unmapmerge.xls $pav_dir2/$sam/$sam.ref2unmap.reads $pav_dir2/$sam/step08.$sam.unmapmerge_lowmap.xls\n";
